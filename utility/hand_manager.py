...
import math
import pygame
from utility.card import Card, CARD_WIDTH
...
class HandManager:
    ...
    def __init__(self, screen_width: int, screen_height: int, is_bottom: bool = True):
        ...
        # Oval parameters - adjusted so full cards are visible
        self.center_x = screen_width // 2
        if is_bottom:
            self.center_y = screen_height + 50  # Oval center just below screen
        else:
            self.center_y = -50  # Oval center just above screen

        self.radius_x = screen_width * 0.35
        self.radius_y = 180  # Cards curve up from center
